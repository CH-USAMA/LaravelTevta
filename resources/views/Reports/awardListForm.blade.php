...
<div class="container-fluid">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb my-0 ms-2">
      ...
      <li class="breadcrumb-item active"><span>Award List</span></li>
    </ol>
  </nav>
</div>
</header>
      ...
      <div class="body flex-grow-1 px-3">
        <div class="container-lg">
          <div class="card mb-4">
            ...
            <div class="card-body">
              <form class="row g-3" method="POST" action="{{url('award_list_report')}}">
               @csrf
              ...
              <div class="col-md-6">
                ...
                @enderror
                  ...
                  <input name="Date" class="form-control @error('Date') is-invalid @enderror"  required autocomplete="Date" autofocus  id="Date" type="date">
                  @error('Date')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
