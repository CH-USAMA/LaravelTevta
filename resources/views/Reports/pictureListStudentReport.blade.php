...
<div class="col-md-6 col-s-12" style="text-align: center;">
  <h3>List Of Pictures For The Session:{{$session_end_date}}</h3>
  <h5>Centre Name:{{$centre_name}} Code:{{$trade_code}} Group/Shift: {{$list_group}} Duration:{{$course_duration}} Months</h5>
</div>

<table>
  <tr>
    <th><b>Sr No.</b></th>
    <th><b>CNIC NUMBER</b></th>
    ...
    <th><b>Picture</b></th>
                  ...
                  <tr>
                    ...
                    <td>{{ $student->ses_sex}}</td>
                    <td>{{ $student->ses_pic}}</td>
                  </tr>
                   @endforeach
