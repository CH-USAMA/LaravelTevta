...
<div class="container-fluid">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb my-0 ms-2">
      ...
      <li class="breadcrumb-item active"><span>Centre/Trade Summary</span></li>
    </ol>
  </nav>
</div>
</header>
      ...
      <div class="body flex-grow-1 px-3">
        <div class="container-lg">
          <div class="card mb-4">
            ...
            <div class="card-body">
              <form class="row g-3" method="POST" action="{{url('result-statement-report')}}">
               @csrf
              ...
              <div class="col-md-6">
                <label class="form-label" for="role">Copy For</label>
                <select name="CopyType" class="form-select @error('CopyType') is-invalid @enderror" required id="CopyType">
                  <option disabled= selected >Choose...</option>
                  <option value="CopyForCertificate">Copy For Certificate</option>
                  <option value="CopyForOffice">CopyFor Office</option>
                  <option value="CopyForPrinciple">Copy For Principle</option>
                </select>
                @error('CopyType')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
