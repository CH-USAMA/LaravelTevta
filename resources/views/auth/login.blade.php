...
<html lang="en">
  <head>
    ...
    <title>Trade Testing Board</title>
          ...
          <div class="col-lg-9">
            <div class="card-group d-block d-md-flex row">
              <div class="card col-md-7 p-4 mb-0">
                <div class="card-body">
                  <h1>TTBP Short Courses Examination System</h1>
                  <form method="POST" action="{{ route('login') }}">
                        @csrf
                        
                  <p class="text-medium-emphasis">Use a valid username and password to gain access to the administration console.</p>
