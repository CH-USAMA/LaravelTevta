...
@section('title', 'All Student Information Show')
@section('content')
...
<div class="container-fluid">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb my-0 ms-2">
      ...
      <li class="breadcrumb-item active"><span>All Students</span></li>
    </ol>
  </nav>
</div>
</header>
...
<div class="body flex-grow-1 px-3">
  <div class="container-lg">
    <div class="body flex-grow-1 px-3">
        <div class="container-lg">
          <div class="card mb-4">
          <form action="{{ url('AllStudentList')}}" method="POST" >
            @csrf
            <input type="hidden" name="table" value="session">
            
            <div class="card-header">List of ALL Students
            ...
            <table id="example" class="table striped" >
                ...
                <tbody>
                  ...
                  @foreach($students as $student)
                    ...
                    <th>{{$student->id}}</th>
                    <td><a href="{{ route('editStudentByAdmin',['ses_cnic_no' => Crypt::encrypt($student->ses_cnic_no) ,'session' => Crypt::encrypt($student->ses_name)])}}">{{ $student->ses_cnic_no}}</a></td>
