...
<div class="container-fluid">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb my-0 ms-2">
      ...
      <li class="breadcrumb-item active"><span>Submit Students Data</span></li>
    </ol>
  </nav>
</div>
</header>
...
<div class="body flex-grow-1 px-3">
  <div class="container-lg">
    ...
    <div class="body flex-grow-1 px-3">
        <div class="container-lg">
          <div class="card mb-4">
            <div class="card-header">Enter Session To Submit</div>
            <div class="card-body">
              <!-- content here -->
              <div class="body flex-grow-1 px-3">
                <div class="container-lg">
                <form class="row g-3" method="POST" action="{{ route('studentDataSubmit')}}">
                    @csrf
                    <div class="col-md-6">
